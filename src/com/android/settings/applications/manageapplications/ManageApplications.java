...
public class ManageApplications extends InstrumentedFragment
    ...
    void updateOptionsMenu() {
        ...
        mOptionsMenu.findItem(R.id.sort_order_alpha).setVisible((mListType == LIST_TYPE_STORAGE || mListType == LIST_TYPE_MAIN)
                && mSortOrder != R.id.sort_order_alpha);
        mOptionsMenu.findItem(R.id.sort_order_size).setVisible((mListType == LIST_TYPE_STORAGE || mListType == LIST_TYPE_MAIN)
                && mSortOrder != R.id.sort_order_size);
